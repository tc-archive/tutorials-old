...
% sensor, actuator, and neuron PId lists. The message also specifies how many total
% Sense- Think-Act cycles the Cortex should execute before terminating the NN system. Once we
% implement the learning algorithm, the termination criteria will depend on the fitness of the NN,
% or some other useful property.
%
...
% APIds list from the MAPIds. Finally, there is also the Step variable which decrements every time
% a full cycle of Sense-Think-Act completes, once this reaches 0, the NN system begins its
% termination and backup process.
%
