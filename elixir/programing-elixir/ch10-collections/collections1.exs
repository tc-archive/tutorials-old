# *************************************************************************************************
# 
#  - In the last exercise of the Lists and Recursion chapter, you wrote a span funtion. Use it and 
#    list comprehensions to return a list of the prime numbers from 2 to n.
# 
# 
#  - Pragmatic Bookshelf has offices in Texas (TX) and North Carolina (NC), so we have to charge 
