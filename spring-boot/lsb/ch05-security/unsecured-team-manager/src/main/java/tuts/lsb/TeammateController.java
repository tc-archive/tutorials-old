...
public class TeammateController {
    ...
    public ModelAndView editTeammate(@PathVariable Long id) {
        ...
        Link updateTeammateLink =
                linkTo(methodOn(TeammateController.class).updateTeammate(id, teammate)).withRel("Update");
        mav = mav.addObject("putLink", updateTeammateLink);

        List<Link> teammateLinks =
                Arrays.asList(linkTo(methodOn(TeammateController.class).getTeammate(id)).withRel("Cancel"));
        mav = mav.addObject("links", teammateLinks);
